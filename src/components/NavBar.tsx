                    ...
                    <div className='text-sm lg:flex-grow'>
                        ...
                        { 
                            !auth.currentUser? (
                                <Button className='p-3 m-5 bg-teal-400 justify-center'>
                                    <div>
                                        <Link to='/' onClick={signInOnClick} className='flex place-items-center mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4'>
                                            Login
                                        </Link>
                                    </div>
                                </Button>
                                ...
                                <Button className='p-3 m-5 bg-teal-400 justify-center'>
                                    <div>
                                        <Link to='/' onClick={signOutOnClick} className='flex place-items-center mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4'>
                                            Sign out
                                        </Link>
                                    </div>
                                </Button>
